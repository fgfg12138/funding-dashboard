      ...
      <div className="mx-auto max-w-[1800px] space-y-5">
        <header className="flex flex-col gap-3 border-b border-slate-800 pb-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-2xl font-semibold text-white">策略管理</h1>
            <p className="mt-1 text-sm text-slate-400">只读 strategy configuration. 无 API Key, no orders, 不执行.</p>
          </div>
